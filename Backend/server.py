...
def create_visualization_charts(patient_df, time_series_data, predictions, current_visus, predicted_visus,
                                predicted_class):
    ...
    try:
        ...
        response = {
            ...
            'prediction': {
                ...
                'confidence': 0.75 if predicted_class == 'worsened' else 0.65,
